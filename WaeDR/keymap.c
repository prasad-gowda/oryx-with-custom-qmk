...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_NO,          KC_Q,           KC_W,           KC_F,           KC_P,           KC_B,           KC_NO,                                          KC_NO,          KC_J,           KC_L,           KC_U,           KC_Y,           KC_MEH,         KC_NO,          
    KC_NO,          MT(MOD_LCTL, KC_A),MT(MOD_LALT, KC_R),MT(MOD_LGUI, KC_S),MT(MOD_LSFT, KC_T),KC_G,           KC_NO,                                                                          KC_NO,          KC_M,           MT(MOD_RSFT, KC_N),MT(MOD_RGUI, KC_E),MT(MOD_RALT, KC_I),MT(MOD_RCTL, KC_O),KC_NO,          
    KC_NO,          KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       KC_DOT,         KC_ENTER,       KC_NO,          
    KC_NO,          KC_CAPS,        LT(3,KC_LEFT),  LT(1,KC_RIGHT), KC_SPACE,       KC_ESCAPE,                                                                                                      KC_TAB,         MT(MOD_RSFT, KC_BSPC),LT(2,KC_UP),    LT(4,KC_DOWN),  KC_HYPR,        KC_NO,          
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_NO,          KC_MAC_CUT,     KC_MAC_COPY,    KC_MAC_PASTE,   KC_DELETE,      KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_MS_WH_UP,    KC_MS_WH_LEFT,  KC_MS_UP,       KC_MS_WH_RIGHT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_NO,          LGUI(KC_GRAVE), KC_MS_BTN3,     KC_MS_BTN2,     KC_MS_BTN1,     KC_HOME,        KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_MS_WH_DOWN,  KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    LGUI(LCTL(LSFT(KC_4))),KC_NO,          
    KC_TRANSPARENT, MAC_MISSION_CONTROL,KC_MS_ACCEL2,   KC_MS_ACCEL1,   KC_MS_ACCEL0,   KC_END,                                         KC_AUDIO_VOL_UP,KC_AUDIO_VOL_DOWN,KC_PGDN,        KC_PAGE_UP,     LGUI(LSFT(KC_4)),KC_NO,          
    KC_TRANSPARENT, TO(0),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_AUDIO_VOL_UP,KC_BRIGHTNESS_UP,KC_BRIGHTNESS_DOWN,KC_NO,          KC_NO,          KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_NO,          KC_NO,          KC_UP,          KC_NO,          KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_NO,          KC_AUDIO_MUTE,  KC_MEDIA_PREV_TRACK,KC_MEDIA_PLAY_PAUSE,KC_MEDIA_NEXT_TRACK,KC_MEDIA_STOP,  KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_NO,          KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_NO,          KC_TRANSPARENT, 
    KC_NO,          KC_AUDIO_VOL_DOWN,MAC_MISSION_CONTROL,MAC_SPOTLIGHT,  MAC_SIRI,       MAC_DND,                                        KC_NO,          KC_TAB,         KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_TRANSPARENT, TO(0),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 QK_BOOT,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [4] = LAYOUT_moonlander(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
...
const uint16_t PROGMEM combo0[] = { KC_HYPR, LT(1,KC_RIGHT), COMBO_END};
const uint16_t PROGMEM combo1[] = { KC_HYPR, LT(2,KC_UP), COMBO_END};
const uint16_t PROGMEM combo2[] = { KC_HYPR, LT(3,KC_LEFT), COMBO_END};
const uint16_t PROGMEM combo3[] = { KC_HYPR, LT(4,KC_DOWN), COMBO_END};
